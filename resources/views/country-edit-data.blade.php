            ...
            <div class="row page-bg">
                <div class="p-4 col-md-12">
                    <div class="text-center top-icon">
                        ...
                        <form id="form-login" action="{{ route('country.update', $data->id) }}" method="post" onsubmit="return confirm('Are you sure to edit data?');">
                            @csrf

                            <div>
                                <input class="mt-3 form-control form-control-lg @error('name') is-invalid @enderror" name="name" type="text"
                                       placeholder="Name" value="{{ old('name', $data->name ? $data->name : 'Tidak Ada Data') }}" autofocus required>
                            </div>
                        ...
                        <div class="mt-4 text-center submit-btn">
                            <a href="{{ route('home') }}" class="btn btn-secondary" onclick="return confirm('Back to homepage?');">Kembali</a>
